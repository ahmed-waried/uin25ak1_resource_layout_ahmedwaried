...
function addProductToCart(prodid) {
    ...
    const idExists = cart.some(cartprod => cartprod.prodid === prodid)
...
//Lage en funksjon som skriver ut en oppdatert versjon av handlevognen
function printCart() {
    ...
    //Skrive ur generert HTML til index-fila
